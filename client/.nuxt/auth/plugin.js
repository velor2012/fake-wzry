...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/admins/login","method":"post","propertyName":"token"},"logout":{"url":"/admins/logout","method":"get"},"user":{"url":"/admins/currentUser","method":"get","propertyName":false}},"_name":"local"}))
