...
import nuxt_plugin_axios_8ab63788 from 'nuxt_plugin_axios_8ab63788' // Source: ./axios.js (mode: 'all')
...
import nuxt_plugin_card_926fd1f8 from 'nuxt_plugin_card_926fd1f8' // Source: ../plugins/card (mode: 'all')
...
async function createApp (ssrContext) {
  ...
  const app = {
    head: {"title":"web","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"My smashing Nuxt.js project"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_axios_8ab63788 === 'function') {
    await nuxt_plugin_axios_8ab63788(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_card_926fd1f8 === 'function') {
    await nuxt_plugin_card_926fd1f8(app.context, inject)
  }
